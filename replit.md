...
- July 10, 2025. Optimized home feed display: limited main feed to maximum 8 lines of posts to reduce scrolling before "Ver todas as artes" button. Feed now calculates display limit based on screen width (8 lines × number of columns) while maintaining responsive grid layout across different devices.
