...
- July 1, 2025. Improved navigation consistency: changed admin button colors from brown/amber to light blue (#border-blue-300 text-blue-500) across mobile and desktop for visual consistency. Removed "Início" link from desktop navigation menu, maintaining only logo as home link for cleaner, minimalist UI design.
