          ...
          {hasCustomLogo ? (
            ...
            <>
              ...
              <span className="ml-2 font-bold text-lg">
                <span className="text-foreground">Design</span><span className="text-[#AA5E2F]">paraEstética</span>
              </span>
            </>
          )}
        </div>
...
const LinksUteis = () => (
  <div>
    <h3 className="text-foreground font-semibold text-base mb-4">Links Úteis</h3>
    <ul className="space-y-3">
      <li><Link href="/sobre" className="text-muted-foreground hover:text-[#a15e38] transition duration-300 text-sm">Sobre nós</Link></li>
      <li><Link href="/planos" className="text-muted-foreground hover:text-[#a15e38] transition duration-300 text-sm">Planos</Link></li>
      <li><Link href="/duvidas" className="text-muted-foreground hover:text-[#a15e38] transition duration-300 text-sm">Dúvidas</Link></li>
    </ul>
  </div>
);
...
const Politicas = () => (
  <div>
    <h3 className="text-foreground font-semibold text-base mb-4">Políticas</h3>
    <ul className="space-y-3">
      <li><a href="#" className="text-muted-foreground hover:text-[#a15e38] transition duration-300 text-sm">Termos de uso</a></li>
      <li><a href="#" className="text-muted-foreground hover:text-[#a15e38] transition duration-300 text-sm">Política de privacidade</a></li>
      <li><a href="#" className="text-muted-foreground hover:text-[#a15e38] transition duration-300 text-sm">Denúncia e Direitos Autorais</a></li>
    </ul>
  </div>
);
