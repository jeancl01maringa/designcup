    ...
    <section className="py-8 bg-white border-b border-gray-100">
      <div className="container-global">
        ...
        <div className="mb-4 flex items-start justify-between">
          ...
          <Link 
            href="/categorias" 
            className="bg-white hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors border border-gray-200 shadow-sm"
          >
                ...
                <div key={`${category.id}-${index}`} className="flex-none w-80">
                  <div className="relative">
                    ...
                    <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 z-30">
                      <div className="bg-white rounded-full px-4 py-2 shadow-lg shadow-gray-400/30 min-w-[120px]">
