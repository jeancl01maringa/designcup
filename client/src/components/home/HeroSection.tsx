    ...
    <section className="bg-gradient-to-b from-[#FFF4E9] to-[#FFFCF9] pt-16 sm:pt-20 pb-8 md:pb-12">
      <div className="container-global flex flex-col items-center text-center">
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-[#393B40] leading-tight mb-4 sm:mb-6 font-montserrat px-4 sm:px-0">
          ...
          <span className="block font-bold bg-gradient-to-r from-[#FF6B4A] to-[#FFB366] bg-clip-text text-transparent">de Artes para</span>
          <span className="block font-bold bg-gradient-to-r from-[#FF6B4A] to-[#FFB366] bg-clip-text text-transparent">Estética do Brasil</span>
        </h1>
